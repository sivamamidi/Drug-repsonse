...
from models.Mgat import MHGATNet
from utils import *
import datetime
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=int, required=False, default=0,     help='0: GINConvNet, 1: GATNet, 2: GAT_GCN, 3: GCNNet, 4: MHGATNet')
    ...
    modeling = [GINConvNet, GATNet, GAT_GCN, GCNNet, MHGATNet][args.model]
